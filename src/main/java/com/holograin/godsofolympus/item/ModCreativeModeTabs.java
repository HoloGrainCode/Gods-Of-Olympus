package com.holograin.godsofolympus.item;

import com.holograin.godsofolympus.GodsOfOlympusMod;
...
public class ModCreativeModeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, GodsOfOlympusMod.MOD_ID);
    ...
    public static final Supplier<CreativeModeTab> BLACK_OPAL_ITEMS_TAB =
            CREATIVE_MODE_TABS.register("black_opal_item_tab", () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.godsofolympus.black_opal_item_tab"))
    ...
    public static final Supplier<CreativeModeTab> BLACK_OPAL_BLOCKS_TAB =
            CREATIVE_MODE_TABS.register("black_opal_blocks_tab", () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.godsofolympus.black_opal_blocks _tab"))
                    .icon(() -> new ItemStack(ModItems.RAW_BLACK_OPAL.get()))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(GodsOfOlympusMod.MOD_ID,"black_opal_item_tab"))
                    .displayItems((itemDisplayParameters, output) -> {
